...
import com.example.user.chatroom.implementation.ChatDetailPresenter;
import com.example.user.chatroom.util.AudioRecorderUtil;
import com.example.user.chatroom.util.MediaPlayerUtil;
import com.example.user.chatroom.util.ProgressTextUtil;
...
public class ChatDetailActivity extends BaseActivity<ChatDetailPresenter> implements ChatDetailContract.View {
            ...
            public void onFileClick(int position) {
                ...
                if (bean.getFileState() == FileState.RECEIVE_FILE_FINISH
                    ...
                    if (mineType != null){
                        ...
                        if (list.size() == 0){
                            showToast("Cannot open this file!");
                        }else {
        ...
        switch (requestCode) {
            ...
            case FILE_MANAGER:
                if (resultCode == RESULT_OK) {
                    ...
                    fileMsg.setUserIp(mTargetPeerIp);
    ...
    private void openCamera() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            mTakePhotoUri = FileProvider.getUriForFile(ChatDetailActivity.this, "com.example.user.p2p.fileprovider", mTakePhotoFile);
        } else {
